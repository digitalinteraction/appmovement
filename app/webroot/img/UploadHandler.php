...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        1 => 'File is too big (max 3mb)',
        2 => 'File is too small (min 2kb)',
        ...
        'accept_file_types' => 'Filetype not allowed - it must be (.gif .jpg .jpeg .png)',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/movements/',
            'upload_url' => $this->get_full_url().'/movements/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
