...
<?php
echo $this->Html->css('terms', null, array('inline'=>false));
?>

<div class="row banner-row">
	<div class="container">

		<h3><?php echo __('Privacy Policy'); ?></h3>
...
<div class="row">
	...
	<div class="container">
		...
		<div class="page-panel">
			...
			<p><strong>Opt-Out Process:</strong> If you do not want to receive email communications (including email digests) from us in the future, please send an email to us at <a href="mailto:admin@app-movement.com">admin@app-movement.com</a> requesting to be removed from our mailing list. You will also have the option of clicking on a link included in email correspondence you receive from us in order to remove yourself from our mailing list.</p>

			<p>If you do not want to want to receive our newsletters in the future, please send an email to us at <a href="mailto:admin@app-movement.com">admin@app-movement.com</a> requesting to be removed from our mailing list. You will also have the option of clicking on a link included in the newsletters you receive from us in order to remove yourself from our mailing list.</p>
			...
			<p>Site Terms of Use: Use of this Site is governed by, and subject to, the Terms of Use contained at <a href="http://appmovement.com/terms">https://appmovement.com/terms</a>. This Privacy Policy is incorporated into such terms. Your use, or access, of the Site constitutes your agreement to be bound by these provisions.</p>
			...
			<p><strong>Contact:</strong> For questions or concerns relating to privacy, we can be contacted at: <a href="mailto:admin@app-movement.com">admin@app-movement.com</a>.</p>

			<p>Effective Date: This Privacy Policy was last updated on 19th August 2014.</p>
