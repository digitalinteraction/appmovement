...
if (!isset($is_winning_contribution)) {
	$is_winning_contribution = false;
}
?>

<div class="tile option-tile <?php if($is_winning_contribution) { echo 'winning-contribution'; } ?>" id="contribution-<?php echo $item["Contribution"]["id"]; ?>">
