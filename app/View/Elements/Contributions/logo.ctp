...
<div class="tile logo-tile" id="contribution-<?php echo $item["Contribution"]["id"]; ?>">
		...
		<table>
			<tr>
				<td valign="middle" rowspan="3" style="height: 160px; width:100%">
					<?php echo $this->Html->image('contributions/small/' . $contribution->url, array('alt' => 'Contribution Image', 'class' => 'img-responsive')); ?>
				</td>
