...
<div class="notification stat-notification" style="text-align: center; border-bottom: #DDD 1px dashed; padding: 20px; position: relative;">
	...
	<h2 style="color: #999; font-size: 24px; font-weight: 200; line-height: 60px; margin: 0px; padding: 0px;"><span style="color: #5cb85c; font-weight: normal; padding-right: 5px">+<?php echo __('%s</span> Shared Movement</span>', $promoter_count); ?></h2>
