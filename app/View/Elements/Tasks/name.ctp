...
<?php
echo $this->Html->css('tasks/name', null, array('inline'=>false));
?>
	...
	<div class="row">
		<div class="container contribute-area">
			<div class="contribute-container">
		    	...
		    	<?php echo $this->Form->input('App Name', array('class' => 'input-field', 'id' => 'contribution-input', 'placeholder' => __('Enter %s', __($design_task["AppTypeDesignTask"]["DesignTask"]["name"])), 'label' => false)); ?>
