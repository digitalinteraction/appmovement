...
<div class="email-container" style="background-color: #f9f9f9; margin: 10px 0px 0px 0px; width: 100%; max-width: 680px; <?php if ($rtl) { echo 'direction: rtl; text-align: right;'; } else { echo 'text-align: left;'; } ?>">
	...
	<div class="email-banner" style="background-color: #5dd0d0; margin: 0; padding: 0; padding-top: 20px; text-align: center;">
		...
		<h3 style="color: #fff; font-size: 1.8em; font-weight: 300; margin: 0; padding: 10px 10px 20px 10px;"><?php echo __('Support Phase Complete'); ?></h3>

		<div class="banner-subtitle" style="background-color: #58c4c4;">

			<p style="color: #fff; font-size: 1.2em; font-weight: 300; margin: 0; padding: 20px 10px;"><?php echo __('Over <strong>%s</strong> people have supported the idea of creating an app for %s', $supporter_count, $this->Html->link($movement_title, $this->Html->url(array('controller' => 'movements', 'action' => 'view', $movement_id),true), array('style' => 'color:#fff'))); ?></p>
	...
	<div class="email-body" style="padding: 15px;">
		...
		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('Your Movement will now move into the design phase. This is an area where yourself and other supporters complete a series of design tasks to help decide what the final app will be like.'); ?></p>

		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('It is really import to engage with other supporters of the app to ensure the app we build for you is perfect!'); ?></p>

		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('Get started with the design process now by clicking the following link.'); ?></p>

		<?php echo $this->Html->link('<div style="padding:10px 26px 10px 26px; font-size: 18px; color: #fff; background-color: #5BCA5B; border: #4cae4c 1px solid; text-align: center; line-height: 1.33; border-radius: 6px; display: inline-block;">' . __('Help Design App') . '</div>', $this->Html->url(array('controller' => 'tasks', 'action' => 'landing', $movement_id),true), array('escape' => false, 'style' => 'color:#58c4c4')); ?>
