...
<div class="email-container" style="background-color: #f9f9f9; margin: 10px 0px 0px 0px; width: 100%; max-width: 680px; <?php if ($rtl) { echo 'direction: rtl; text-align: right;'; } else { echo 'text-align: left;'; } ?>">
	...
	<div class="email-banner" style="background-color: #5dd0d0; margin: 0; padding: 0; padding-top: 20px; text-align: center;">
		...
		<h3 style="color: #fff; font-size: 1.8em; font-weight: 300; margin: 0; padding: 10px 10px 20px 10px;"><?php echo __('Support Your Friend'); ?></h3>

		<div class="banner-subtitle" style="background-color: #58c4c4;">

			<p style="color: #fff; font-size: 1.2em; font-weight: 300; margin: 0; padding: 20px 10px;"><?php echo __('Hey %s, your friend %s is trying to gain support for an idea for a new mobile app.', $target_name, $sender_name); ?></p>
	...
	<div class="email-body" style="padding: 15px;">
		...
		<?php if (!$rtl): ?>
			...
			<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('%s has chosen you amongst a handful of other people to support their Movement and help share their idea with others.', $sender_name); ?></p>

		<?php endif ?>

		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('You can help %s out by clicking the link below to support their Movement:', $sender_name); ?></p>

		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo $this->Html->link($movement_title, $movement_link); ?></p>

		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('If %s\'s idea gains enough support then yourself and other supporters will be able to help design the app. Pretty awesome eh?', $sender_name); ?></p>
		
		<p style="font-size: 1em; margin: 15px 0px; padding: 0;"><?php echo __('Do you have a great idea for an app?'); ?></p>

		<?php echo $this->Html->link(__('Start your Movement'), $this->Html->url(array('controller' => 'movements', 'action' => 'start'),true), array('style' => 'color:#58c4c4')); ?>
