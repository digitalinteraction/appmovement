...
<div class="row">
	...
	<div class="container">
		...
		<div class="venue-container">
			...
			<?php
			echo $this->Html->link('<i class="fa fa-chevron-left"></i>', array('controller' => 'published_apps', 'action' => 'venue', $published_app["PublishedApp"]["id"], $neighbours["prev"]["Venue"]["id"]), array('escape' => false,'class' => 'navigation-arrow', 'id' => 'prev-arrow'));
			echo $this->Html->link('<i class="fa fa-chevron-right"></i>', array('controller' => 'published_apps', 'action' => 'venue', $published_app["PublishedApp"]["id"], $neighbours["next"]["Venue"]["id"]), array('escape' => false,'class' => 'navigation-arrow', 'id' => 'next-arrow'));
			?>
			...
			<div class="block" id="photos-block">
				<?php foreach ($venue["Review"] as $index => $review) { ?>
			...
			<div class="block" id="other-reviews-block">
				...
				<h4><?php echo (count($venue["Review"]) == 1) ? count($venue["Review"]) . ' Review' : count($venue["Review"]) . ' Reviews'; ?></h4>
